    ...
    <div class="p-3 mb-4 bg-white border rounded-3">
        <div class="container-fluid py-3">
            ...
            <p class="fs-4">Доска бесплатных объявлений <strong>{{config('app.name')}}</strong> позволяет легко и просто
                добавить свое объявление. Причем совершенно бесплатно! Все объявления разбиты по рубрикам. Если вы
                хотите разместить свое объявление бесплатно и в кратчайшие сроки, то смело жмите на кнопку ниже!</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            @if($user->id === $card->user_id && $user->isProUser())
                                <p class="card-text">Просмотры: {{ $card->view_count }}</p>
                                <p class="card-text">Избранное: {{ $card->favorites->count() }}</p>
                            @endif
